...
#ifdef _SHR
  int k, blk;
  __shared__ float shrx[256], shry[256], shrz[256];
#endif
...
int main(int argc, char **argv)
{
 ...
 fp=fopen("md_cuda_velet_energy.dat", "w");
 gp=fopen("md_cuda_velet_data.dat", "w");
 ip=fopen("init_pos_cuda_velet.dat", "w");
 op=fopen("final_pos_velet_cuda.dat", "w");
